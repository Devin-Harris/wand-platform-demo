<template>
  <div class="translator">
    <div class="translation-boxs">
      <div class="input">
        <dropdown :selectedItem="detectedLang ? detectedLang.name : inputLang.name" :items="availableLangNames" @item-selected="selectInputLang($event)" :isDropdownGrid="true" :keyBase="'input'" />
      ...
      <div class="output">
        <dropdown :selectedItem="outputLang.name" :items="availableLangNames"  @item-selected="selectOutputLang($event)" :isDropdownGrid="true" :keyBase="'output'" />
